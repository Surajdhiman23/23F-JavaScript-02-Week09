...
/* STEP 2b: Use the console to create a coxuple of different people, using the 'new' keyword,
...
*/
function createHamburger(bunType, toppings, cheese, sauce, pattyType, pattyCount, extras) {
    var hamburger = {
        bunType: bunType,
        toppings: toppings,
        cheese: cheese,
        ...
        description: function() {
            return `This hamburger has a ${this.bunType} bun with a ${this.pattyCount} ${this.pattyType} patty, topped with ${this.toppings.join(', ')}, ${this.cheese} cheese, and ${this.sauce} sauce, plus ${this.extras.join(', ')}.`;
        }
    };
    return hamburger;
}
